...
const int typeMax[DestinationType_Max] = {0, 6, 22, 58, 2, 3, 3, 10, 2, 66};
...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR lpCmd, int nShow)
{
    ...
    /*
    cout << PlaceName[FirstChoose][SecondChoose].Nearest(Station) << "站到";
    cout << PlaceName[ThirdChoose][FourthChoose].Nearest(Station) << "站\n";
    */
